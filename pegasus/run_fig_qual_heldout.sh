...
#PBS -N fig_qual_heldout               # redraw paper/figures/fig_qual_combined.pdf from CLEAN fold-0 ckpts
#PBS -o logs/pegasus/fig_qual_heldout_out.log
#PBS -e logs/pegasus/fig_qual_heldout_err.log
